...
main_conf = {
    ...
    "train_window": [
        ...
        (dt.datetime.strptime("2004-01-01", "%Y-%m-%d"), dt.datetime.strptime("2007-01-01", "%Y-%m-%d")),
        (dt.datetime.strptime("2005-01-01", "%Y-%m-%d"), dt.datetime.strptime("2008-01-01", "%Y-%m-%d")),
        (dt.datetime.strptime("2006-01-01", "%Y-%m-%d"), dt.datetime.strptime("2009-01-01", "%Y-%m-%d")),
        (dt.datetime.strptime("2007-01-01", "%Y-%m-%d"), dt.datetime.strptime("2010-01-01", "%Y-%m-%d")),
        (dt.datetime.strptime("2008-01-01", "%Y-%m-%d"), dt.datetime.strptime("2011-01-01", "%Y-%m-%d")),
        (dt.datetime.strptime("2009-01-01", "%Y-%m-%d"), dt.datetime.strptime("2012-01-01", "%Y-%m-%d")),
        (dt.datetime.strptime("2010-01-01", "%Y-%m-%d"), dt.datetime.strptime("2013-01-01", "%Y-%m-%d")),
        (dt.datetime.strptime("2011-01-01", "%Y-%m-%d"), dt.datetime.strptime("2014-01-01", "%Y-%m-%d")),
        (dt.datetime.strptime("2012-01-01", "%Y-%m-%d"), dt.datetime.strptime("2015-01-01", "%Y-%m-%d")),
        (dt.datetime.strptime("2013-01-01", "%Y-%m-%d"), dt.datetime.strptime("2016-01-01", "%Y-%m-%d")),
        (dt.datetime.strptime("2014-01-01", "%Y-%m-%d"), dt.datetime.strptime("2017-01-01", "%Y-%m-%d")),
    ...
    "reg_ens_full": "reg_ens_full_pred",
    "reg_ens_best": "reg_ens_best_pred",
    "reg_ens_best_cv": "reg_ens_best_cv_pred",
    ...
    "features": ["Close", "Open", "Volume", "High", "Low",
                 ...
                 "lagged_daily_rt_9", "lagged_daily_rt_10", "ta_ema", "stoch", "ta_proc",
                 "ta_rsi", "macd", "will_r_ind", "disp_5", "disp_10", "adi"],
    "features_TI": ["Close", "Open", "Volume", "High", "Low", "ta_ema", "stoch", "ta_proc",
                    "ta_rsi", "macd", "will_r_ind", "disp_5", "disp_10", "adi"],
    "features_LR": ["Close", "Open", "Volume", "High", "Low",
                    "lagged_daily_rt_1", "lagged_daily_rt_2", "lagged_daily_rt_3",
                    "lagged_daily_rt_4", "lagged_daily_rt_4", "lagged_daily_rt_5",
                    "lagged_daily_rt_6", "lagged_daily_rt_7", "lagged_daily_rt_8",
                    "lagged_daily_rt_9", "lagged_daily_rt_10"],
